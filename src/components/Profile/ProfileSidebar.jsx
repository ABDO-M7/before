...
const ProfileSidebar = () => {
    ...
    // Hide sidebar on mobile (d-none d-lg-block) so profile pages get full-width content on phones while keeping the classic layout on desktop.
    // if you want to show the sidebar on mobile, you can remove the d-none d-lg-block class from the div.
    return (
