...
const FilterCard = ({ slug, setMinMaxPrice, setIsFetchSingleCatItem, setCountry, setState, setCity, selectedLocationKey, setSelectedLocationKey, setIsShowBudget, DatePosted, setDatePosted, setArea, setKmRange, setCategoryIds, CustomFields, setExtraDetails, ExtraDetails, setIsShowExtraDet, setIsShowKmRange, treeData }) => {
    ...
    // ✅ Use useTransition for filter updates - keeps UI responsive
    ...
    const collapseItems = [
        {
            key: '1',
            label: t("category"),
            children: <FilterTree slug={slug} setCategoryIds={setCategoryIds} treeData={treeData} />
        },
        {
            key: '2',
            label: t("location"),
            id: 'loc',
            children: <LocationTree setCountry={setCountry} setState={setState} setCity={setCity} setArea={setArea} setIsFetchSingleCatItem={setIsFetchSingleCatItem} selectedLocationKey={selectedLocationKey} setSelectedLocationKey={setSelectedLocationKey} setKmRange={setKmRange} setIsShowKmRange={setIsShowKmRange} />
        },
        {
            key: '3',
            label: t("budget"),
    ...
    // ✅ Add extra details panel if custom fields exist
    if (CustomFields && CustomFields.length > 0 && CustomFields.some(field =>
