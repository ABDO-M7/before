                            ...
                            {filePreviews[id] && (
                                <div className='file_wrap'>
                                    {filePreviews[id]?.isPdf ? (
                                        ...
                                        <Image loading="lazy" src={fileUrl} alt="Preview" width={36} height={36} className="file_preview" />
                                    )}
                                </div>
                            )}
                    ...
                    {CustomFields.map((field) => (
                        <div key={field.id} className="col-12 col-lg-6">
                            <div className='extraLabelCont'>
                                <Image loading="lazy" src={field?.image} width={30} alt={field?.name?field.name:''} height={30} />
