      ...
      <div className="container">
        ...
        <div className="row profile_sidebar">
          ...
          <div className="p-0">
            ...
            <div className="row ad_card_wrapper row-cols-xxl-4 row-cols-lg-4 row-cols-md-3 row-cols-2 product_card_card_gap">
              {IsLoading ? (
                Array.from({ length: 12 }).map((_, index) => (
                  <div key={index} className="col product_card_card_gap">
                    <AdsCardSkeleton />
                  </div>
                ))
              ) : MyItems && MyItems?.length > 0 ? (
                MyItems.map((item) => (
                  <div key={item?.id} className="col product_card_card_gap">
