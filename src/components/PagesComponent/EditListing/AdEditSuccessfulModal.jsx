...
const AdEditSuccessfulModal = ({ IsAdSuccessfulModal, OnHide, CreatedAdSlug }) => {
    return (
        <Modal
            centered
        ...
        >
            <div className="adsuccessfull">
                <Image loading="lazy" src={trueGif} width={250} height={250} alt="True" onErrorCapture={placeholderImage} />
                <h2 className="ad_succ_head">{t('adEditedSuccess')}</h2>
                <Link href={`/my-listing/${encodeURIComponent(CreatedAdSlug || '')}`} className="viewAdBtn">{t('viewAd')}</Link>
