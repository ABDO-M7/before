...
import mailVerification from '../../../public/assets/MailVerification.svg'
    ...
    return (
        ...
        >
            <div className='verify_email_modal'>
                <Image loading="lazy" src={mailVerification} width={300} height={195} alt='Email Verification' className='email_verification' onErrorCapture={placeholderImage} />
