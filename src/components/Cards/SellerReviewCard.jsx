            ...
            <div className="reviewCardWrapper">
                <div className="reviewCard">
                    <div className="reviewerDetails">
                        <Image loading="lazy" width={72} height={72} src={rating?.buyer?.profile || placeholder_image} className="reviewerImg" alt="reviewer image" onErrorCapture={placeholderImage} />
